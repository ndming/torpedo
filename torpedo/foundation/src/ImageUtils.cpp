...
void tpd::foundation::recordLayoutTransition(
    ...
    const vk::ImageLayout newLayout)
{
    ...
    const auto subresourceRange = vk::ImageSubresourceRange{}
        ...
        .setBaseArrayLayer(0)
        .setLayerCount(1);     // multi-view images are not supported at the moment
...
std::string tpd::foundation::toString(const vk::ImageLayout layout) {
    using enum vk::ImageLayout;
    switch (layout) {
...
std::string tpd::foundation::toString(const vk::Format format) {
